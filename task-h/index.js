...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (event) => {
    ...
    // Course cell
    const nameCell = document.createElement("td"); nameCell.textContent = fullName; nameCell.className="p-3"; row.appendChild(nameCell);
    ...
    row.className = "p-5 border-b-2 even:[bg-blue-200]";
